			  			...
			  			<div class="  leyenda alert bg-light  alert-dismissible fade show text-left pr-3" role="alert">
			  				<div class="container">
			  					<div class=" d-flex align-items-center">
			  						...
			  						<small>
			  							<strong>Oficina de Narcomenudeo del MPF de Santiago del Estero.</strong><br>
			  							Aquí podrá radicar su denuncia respondiendo unas breves preguntas. El sistema <u>no registrará  su identidad</u>, garantizando su anonimato, por lo cual no se lo involucrará en el proceso ni se solicitará que se acerque a la Fiscalía.
Gracias por su aporte, juntos podemos combatir el flagelo de la venta de estupefacientes.</small>
			  			...
			  			<div class="container text-left">
			  				<h4 class="my-2  text-center text-secondary mt-lg-5">¿Sabe quien vende?</h4>
			  		...
			  		<div class="wrap d-md-flex flex-column  align-items-center justify-content-center ">
			  			<div class="container py-5">
			  				<div class="form-group">
			  					<label class="control-label" for="detail"><h3 class="h5">¿Algo que  le llamó la atención?</h3></label>
			  					<p class="detalle-info"> Aquí podrá brindar información sobre algunas características como: horario, si fue en la puerta de una casa o por la ventana o en la esquina de la cuadra,  que tipo de vehículos, entre  otros datos que  considere necesario mencionar.</p>
			  				...
			  				<p class="my-2">¿Realizó  la denuncia en una comisaría?</p>
			  	...
			  	<div id="step-3" class="setup-content bg-info   text-center text-light pb-4">
			  		<div class="wrap d-md-flex flex-column  align-items-center justify-content-center ">
			  			<div class="container">
			  				<h3 class="h5"> <i class="fas fa-map-marker-alt text-success mt-3"></i> Ingrese la dirección  y ubique en el mapa un punto o la zona a la que refiere la denuncia.</h3>
			  				<div class="form-group">
							...
							<div class="form-group">
			  					...
			  					<p class="mb-1 mt-4">Click sobre el mapa para indicar el punto</p>
